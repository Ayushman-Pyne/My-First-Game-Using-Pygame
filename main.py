...
BULLET_HIT_SOUND=pygame.mixer.Sound(os.path.join(current_path, 'Assets', 'Grenade+1.mp3'))
BULLET_FIRE_SOUND=pygame.mixer.Sound(os.path.join(current_path, 'Assets', 'Gun+Silencer.mp3'))
